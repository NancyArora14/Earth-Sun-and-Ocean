...
document.querySelectorAll('[id^="Details-"] summary').forEach((summary) => {
  ...
  summary.addEventListener('click', (event) => {
    ...
    const icon = event.currentTarget.querySelector('.cst-tog-icon');
    if (icon) {
      if (isOpen) {
        // SVG for plus icon
        icon.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" class="icon icon-plus" viewBox="0 0 10 10">
        ...
        // SVG for minus icon
        icon.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" class="icon icon-minus" viewBox="0 0 10 2">
